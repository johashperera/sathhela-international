...
const Hero = () => {
  return (
    <section className="lg:py-20 xl:py-32">
      <div className="text-center flex flex-col gap-4 items-center">
        <p className="text-primary">Where Fashion meets Authenticity</p>
        <h1 className="lg:text-5xl xl:text-7xl font-medium uppercase">
      ...
      <div className="grid grid-cols-3 gap-7 lg:px-14 xl:px-40 mt-16">
